...
const columns = [
    ...
    { id: 'category', label: 'CATEGORY NAME', minWidth: 250 },
    { id: 'sub-category', label: 'SUB CATEGORY NAME', minWidth: 400 },
        ...
        <>
            <div className="flex items-center justify-between px-2 py-0 mt-3">
                <h2 className="text-[18px] font-[600]">
                    Sub Category List {" "} <span className="font-[400] text-[14px]">(Material UI Table)</span>
                </h2>
                ...
                <div className="col w-[30%] ml-auto flex items-center  gap-3 justify-end">
                    ...
                    )}><FaPlus className="mr-4 text-[25px]" />Add New Sub Category</Button>
                </div>
            </div>
                    ...
                    <Table stickyHeader aria-label="sticky table">
                        ...
                        <TableBody>
                            <TableRow>
                                ...
                                <TableCell >
                                    <Chip label="Fashion" color="primary" />
                                </TableCell>
