                        ...
                        <div className="loginBox card w-[600px] h-auto pb-20 mx-auto pt-20 relative z-50">
                            ...
                            <form className="w-full px-8">
                                <div className="form-group mb-4 w-full">
                                    ...
                                    <input type="email" className="w-full h-[50px] border-2 border-[rgba(0,0,0,0.1)] rounded-md focus:border-[rgba(0,0,0,0.7)] focus:outline-none px-3" placeholder="Enter full name"/>
                                </div>
                                ...
                                <div className="form-group mb-4 w-full flex items-center ">
                                    <FormControlLabel  control={<Checkbox />} /><span>By signing up you have agreed to our <Link to="/"><span className="font-[600]">term </span></Link>& <span className="font-[600]"><Link to="/">Privacy Policy</Link></span></span>
        
                                </div>
        
        
        
                                <Button className="btn-blue btn-lg w-full">Create Account</Button>

                                <div className="mt-4 flex items-end justify-center">
                                    <h2 className="text-[14px] ">Don’t have an account? <Link to="/login" className="font-[600]">Sign Up</Link> </h2>
                                </div>
