        ...
        <>
            <div className="flex items-center justify-between px-2 py-0 mt-3">
                <h2 className="text-[18px] font-[600]">
                    Home Slider Banner {" "} <span className="font-[400] text-[14px]">(Material UI Table)</span>
                </h2>
                ...
                <div className="col w-[30%] ml-auto flex items-center  gap-3 justify-end">
                    ...
                    )}><FaPlus className="mr-4 text-[25px]" />Add Home Slide</Button>
                </div>
            </div>
                    ...
                    <Table stickyHeader aria-label="sticky table">
                        ...
                        <TableBody>
                            <TableRow>
                                ...
                                <TableCell width={300}>
                                    <div className="flex items-center gap-4 w-[300px]"><div className="img w-auto  rounded-md overflow-hidden group"> 
                                        <Link to="/product/457581" data-discover="true">
                                        <img className="w-full group-hover:scale-105 transition-all" src="https://api.spicezgold.com/download/file_1734524878924_1721277298204_banner.jpg" />
                                        </Link>
                                        </div>
